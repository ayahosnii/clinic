							...
							<div class="row">
								<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
									<div class="card-sigin">
										<div class="mb-5 d-flex"> <a href="{{ url('admin/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Va<span>le</span>x</h1></div>
										<div class="card-sigin">
											<div class="main-signup-header">
												...
												<div class="main-signin-footer mt-5">
													...
													<p>Don't have an account? <a href="{{ url('admin/' . $page='signup') }}">Create an Account</a></p>
												</div>
											</div>
										</div>
									</div>
