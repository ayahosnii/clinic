                        ...
                        <div class="col-xl-12">
                            <div class="card mg-b-20">
                                <div class="card-header pb-0">
                                    ...
                                    @can('Export Excel')
                                    <a class="modal-effect btn btn-md btn-warning" href="{{ url('admin/export_invoices') }}"
                                            ...
                                            <tbody>
                                                ...
                                                @endphp
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="text-success" href="{{ url('admin/InvoicesDetails') }}/{{ $invoice->id }}">{{ $invoice->section->section_name }}</a>
