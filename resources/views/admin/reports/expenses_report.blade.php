...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Reports</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Expenses Reports</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="/Search_expenses" method="POST" role="search" autocomplete="off">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            <label class="rdiobox"><input name="rdio" value="2" type="radio"><span> Search By Receipt Number
                            </span></label>
                        </div><br><br>
                            ...
                            <table id="example" class="table key-buttons text-md-nowrap" style=" text-align: center">
                                ...
                                @foreach ($details as $expense)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $expense->category->expense_name}}</td>
