                        ...
                        <div class="card mg-b-20">
                            <div class="card-header pb-0">
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                                    <a class="modal-effect btn btn-success btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">Add Expenses Categories <i class="fas fa-plus fa-sm"></i></a>
                                </div>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleEmailInput">Expenses Categories Name</label>
                ...
                <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('expenses_categories.update', $category->id ?? 0) }}" method="post" autocomplete="off">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    <div class="form-group">
            ...
            <div class="modal" id="modaldemo9">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-content-demo">
                        ...
                        <form action="{{ route('expenses_categories.destroy', $category->id ?? 0) }}" method="post">
                            {{method_field('delete')}}
                            {{csrf_field()}}
                            <div class="modal-body">
